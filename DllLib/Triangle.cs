...
namespace DelaunayVoronoi
{
    public class Triangle
    {
            ...
            get {
                if (this.neighbors.Count <= 0) {
                    foreach (var vertex in Vertices) {
                        foreach (var o in vertex.AdjacentTriangles) {
                            if (o != this && SharesEdgeWith(o) && !this.neighbors.Contains(o))
        ...
        private void UpdateCircumcircle()
        {
            ...
            var center = Point.New(aux1 / div, aux2 / div);
            Circumcenter = center;
        ...
        private void Init(Point point1, Point point2, Point point3)
        {
        ...
        private HashSet<Triangle> neighbors = new HashSet<Triangle>();

        public static Triangle New(Point point1, Point point2, Point point3)
        {
            var obj = s_Pool.Alloc();
            obj.Init(point1, point2, point3);
            return obj;
        }
        private static SimpleObjectPool<Triangle> s_Pool = new SimpleObjectPool<Triangle>();
    }
}